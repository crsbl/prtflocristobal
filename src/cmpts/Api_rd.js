...
export const Api_rd00 = (props) => {
    ...
    style={props.tono_color
        ? {background:"linear-gradient(270deg,rgb(13, 16, 17) 1%, rgb(54, 70, 47) 49%, rgb(62, 78, 55) 100%)"}
        : {background:"linear-gradient(270deg,rgb(46, 54, 53) 1%, rgb(54, 70, 47) 49%, rgb(62, 78, 55) 100%)"}
    }
    >
