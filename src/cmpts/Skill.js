...
export const Skl00 = (props) => {
  ...
  return <div className='D_skl00'>
    ...
    <div className={"d_sklgp00"} style={std_skill.anmc00}>
      ...
      <h1 className='h1_skltitulo00 '
        style={props.estado_tonos
          ? { background: "linear-gradient(270deg, rgb(54, 150, 206)  13%, rgb(43, 126, 165) 85%)" }
          : { background: "linear-gradient(270deg, rgb(17, 69, 99)  13%, rgb(62, 79, 110) 85%)" }}

      ><img className='img_ico_skill00' src={ico_descripcion00}></img> Descripcion </h1>

      <div className='d_skl_descripcion'
        style={props.estado_tonos
          ? { background: "linear-gradient(270deg, rgb(54, 150, 206)  13%, rgb(43, 126, 165) 85%)" }
          : { background: "linear-gradient(270deg, rgb(17, 69, 99)  13%, rgb(56, 82, 129) 85%)" }}
      >
      ...
      <h1 className='h1_skltitulo02 '
        style={props.estado_tonos
          ? { background: "linear-gradient(270deg, rgb(54, 150, 206)  13%, rgb(43, 126, 165) 85%)" }
          : { background: "linear-gradient(270deg, rgb(17, 69, 99)  13%, rgb(62, 79, 110) 85%)" }}
      ><img className='img_ico_skill00' src={ico_mundo00}

      ></img> Nacionalidad</h1>
      <h1 className='h1_skltitulo01 '
        style={props.estado_tonos
          ? { background: "linear-gradient(270deg, rgb(54, 150, 206)  13%, rgb(43, 126, 165) 85%)" }
          : { background: "linear-gradient(270deg, rgb(17, 69, 99)  13%, rgb(56, 82, 129) 85%)" }}
      >  Chileno</h1>
      <h1 className='h1_skltitulo02 '
        style={props.estado_tonos
          ? { background: "linear-gradient(270deg, rgb(54, 150, 206)  13%, rgb(43, 126, 165) 85%)" }
          : { background: "linear-gradient(270deg, rgb(17, 69, 99)  13%, rgb(62, 79, 110) 85%)" }}
      ><img className='img_ico_skill00' src={ico_casa00}></img> Residencia</h1>
      <h1 className='h1_skltitulo01 '
        style={props.estado_tonos
          ? { background: "linear-gradient(270deg, rgb(54, 150, 206)  13%, rgb(43, 126, 165) 85%)" }
          : { background: "linear-gradient(270deg, rgb(17, 69, 99)  13%, rgb(56, 82, 129) 85%)" }}
      ...
      <h1 className='h1_skltitulo02 '
        style={props.estado_tonos
          ? { background: "linear-gradient(270deg, rgb(54, 150, 206)  13%, rgb(43, 126, 165) 85%)" }
          : { background: "linear-gradient(270deg, rgb(17, 69, 99)  13%, rgb(62, 79, 110) 85%)" }}
      ><img className='img_ico_skill00' src={ico_lapiz00}></img> Formacion</h1>
      <h1 className='h1_skltitulo01 '
        style={props.estado_tonos
          ? { background: "linear-gradient(270deg, rgb(54, 150, 206)  13%, rgb(43, 126, 165) 85%)" }
          : { background: "linear-gradient(270deg, rgb(17, 69, 99)  13%, rgb(56, 82, 129) 85%)" }}
      > AIEP Téc. Nivel Superior Programación Computacional.
      </h1>
        ...
        {Stdo_cmnt.map((cmt) => {
          ...
          return <div key={cmt[0]} className={"d_skl01"} style={std_skill.anmc00} >
            <div className='d_skl02'>
              <h1 className='h1_skl00'
                style={props.estado_tonos
                  ? { backgroundColor: "rgb(49, 137, 189)" }
                  : { backgroundColor: "rgb(52, 100, 128)" }}
              >{cmt[0]}</h1>
