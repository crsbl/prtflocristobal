...
const itms_tdos = async()=>{
    const url = 'https://prtflocristobal.000webhostapp.com/bkn00/az_crd.php'
...
const handdle_buscar = (evn)=>{
    ...
    const value = evn.currentTarget.value
    setstds_inpus({...stds_inpus, [evn.target.name]:value })
    Cnslta_pst(4, 'https://prtflocristobal.000webhostapp.com/bkn00/bscr_dts.php', [stds_inpus.buscar])
...
if(stds_inpus.nombre.length > 0 && stds_inpus.marca.length > 0 && stds_inpus.cantidad > 0 && stds_inpus.precio > 0)
{
    Cnslta_pst(1, 'https://prtflocristobal.000webhostapp.com/bkn00/gr_dts.php', [stds_inpus.nombre, stds_inpus.marca, stds_inpus.cantidad, stds_inpus.precio])
...
case 2:
    if(stds_slc.crd.slc_dts != null && stds_inpus.nombre.length > 0 && stds_inpus.marca.length > 0  && stds_inpus.precio > 0)
    {
        ...
        Cnslta_pst(2, 'https://prtflocristobal.000webhostapp.com/bkn00/mdf_dts.php', [stds_slc.crd.slc_dts,stds_inpus.nombre, stds_inpus.marca, stds_inpus.cantidad, stds_inpus.precio])
...
case 3:
    if(stds_slc.crd.slc_dts.length > 0 && stds_inpus.nombre.length > 0 && stds_inpus.marca.length > 0 && stds_inpus.cantidad.length > 0 && stds_inpus.precio.length > 0)
    {
        ...
        Cnslta_pst(3, 'https://prtflocristobal.000webhostapp.com/bkn00/dlt_crd.php', [stds_slc.crd.slc_dts])
