...
const itms_tdos = async()=>{
    const url = 'https://prtflocristobal.000webhostapp.com/bknd/az_crd.php'
...
if(stds_inpus.nombre.length > 0 && stds_inpus.marca.length > 0 && stds_inpus.cantidad > 0 && stds_inpus.precio > 0)
{
    Cnslta_pst(1, 'https://prtflocristobal.000webhostapp.com/bknd/gr_dts.php', [stds_inpus.nombre, stds_inpus.marca, stds_inpus.cantidad, stds_inpus.precio])
...
case 2:
    if(stds_slc.crd.slc_dts != null && stds_inpus.nombre.length > 0 && stds_inpus.marca.length > 0  && stds_inpus.precio > 0)
    {
        ...
        Cnslta_pst(2, 'https://prtflocristobal.000webhostapp.com/bknd/mdf_dts.php', [stds_slc.crd.slc_dts,stds_inpus.nombre, stds_inpus.marca, stds_inpus.cantidad, stds_inpus.precio])
...
case 3:
    if(stds_slc.crd.slc_dts.length > 0 && stds_inpus.nombre.length > 0 && stds_inpus.marca.length > 0 && stds_inpus.cantidad.length > 0 && stds_inpus.precio.length > 0)
    {
        ...
        Cnslta_pst(3, 'https://prtflocristobal.000webhostapp.com/bknd/dlt_crd.php', [stds_slc.crd.slc_dts])
